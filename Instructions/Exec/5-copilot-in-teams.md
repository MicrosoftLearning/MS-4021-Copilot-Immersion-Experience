...
1. Select **Topics**.
    ...
    ![Screenshot showing topics in Copilot in Teams.](../Exec/Media/teams_topics.png)

1. Select **Chapters**.

    ![Screenshot showing chapters in Copilot in Teams.](../Exec/Media/teams_chapters.png)
...
1. Find a Teams Chat thread where you haven't shared any confidential information. Select the option **Open chat in a new window**.
    ...
    ![Screenshot showing Open chat in new window option.](../Exec/Media/teams_open_chat_window.png)
