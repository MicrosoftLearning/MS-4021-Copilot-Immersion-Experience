...
<div class="card-grid">
  ...
  <a class="demo-card" href="/MS-4021-Copilot-Immersion-Experience/Instructions/Demos/3-HR-Demo.html">
    <span class="demo-card-meta"><span class="demo-card-badge">Demo 03</span></span>
    <span class="demo-card-emoji">🧑‍🤝‍🧑</span>
    <span class="demo-card-title">HR</span>
    <span class="demo-card-desc">Speed up people processes — policy drafting, onboarding content, and employee comms.</span>
    <span class="demo-card-cta">Open demo →</span>
  </a>
  <a class="demo-card" href="/MS-4021-Copilot-Immersion-Experience/Instructions/Demos/4-Sales-Demo.html">
    <span class="demo-card-meta"><span class="demo-card-badge">Demo 04</span></span>
    <span class="demo-card-emoji">💼</span>
    <span class="demo-card-title">Sales</span>
    <span class="demo-card-desc">Meeting prep, account research, and follow-up that writes itself.</span>
    <span class="demo-card-cta">Open demo →</span>
  </a>
  <a class="demo-card" href="/MS-4021-Copilot-Immersion-Experience/Instructions/Demos/5-IT-Demo.html">
    <span class="demo-card-meta"><span class="demo-card-badge">Demo 05</span></span>
    <span class="demo-card-emoji">🛠️</span>
    <span class="demo-card-title">IT</span>
    <span class="demo-card-desc">Turn incident noise, documentation, and change requests into clear, actionable output.</span>
    <span class="demo-card-cta">Open demo →</span>
  </a>
  <a class="demo-card" href="/MS-4021-Copilot-Immersion-Experience/Instructions/Demos/6-Executive-Assistant-Demo.html">
    <span class="demo-card-meta"><span class="demo-card-badge">Demo 06</span></span>
    <span class="demo-card-emoji">🗓️</span>
    <span class="demo-card-title">Executive Assistant</span>
    <span class="demo-card-desc">Inbox triage, calendar wrangling, and briefing docs prepared before the day starts.</span>
    <span class="demo-card-cta">Open demo →</span>
  </a>
  <a class="demo-card" href="/MS-4021-Copilot-Immersion-Experience/Instructions/Demos/7-Business-Manager-Demo.html">
    <span class="demo-card-meta"><span class="demo-card-badge">Demo 07</span></span>
    <span class="demo-card-emoji">📊</span>
    <span class="demo-card-title">Business Manager</span>
    <span class="demo-card-desc">Rebuild the weekly status report and team update from scattered sources.</span>
    <span class="demo-card-cta">Open demo →</span>
  </a>
  <a class="demo-card" href="/MS-4021-Copilot-Immersion-Experience/Instructions/Demos/8-Marketing-Demo.html">
    <span class="demo-card-meta"><span class="demo-card-badge">Demo 08</span></span>
    <span class="demo-card-emoji">🎯</span>
    <span class="demo-card-title">Marketing</span>
    <span class="demo-card-desc">Campaign concepting, on-brand copy, and content repurposing at speed.</span>
    <span class="demo-card-cta">Open demo →</span>
  </a>
  <a class="demo-card" href="/MS-4021-Copilot-Immersion-Experience/Instructions/Demos/9-Operations-Demo.html">
    <span class="demo-card-meta"><span class="demo-card-badge">Demo 09</span></span>
    <span class="demo-card-emoji">⚙️</span>
    <span class="demo-card-title">Operations</span>
    <span class="demo-card-desc">Process documentation, supplier summaries, and operational reporting.</span>
    <span class="demo-card-cta">Open demo →</span>
  </a>
  <a class="demo-card" href="/MS-4021-Copilot-Immersion-Experience/Instructions/Demos/10-Legal-Demo.html">
    <span class="demo-card-meta"><span class="demo-card-badge">Demo 10</span></span>
    <span class="demo-card-emoji">⚖️</span>
    <span class="demo-card-title">Legal</span>
    <span class="demo-card-desc">Contract review, clause comparison, and plain-language summaries.</span>
    <span class="demo-card-cta">Open demo →</span>
  </a>
  <a class="demo-card" href="/MS-4021-Copilot-Immersion-Experience/Instructions/Demos/11-Finance-Demo.html">
    <span class="demo-card-meta"><span class="demo-card-badge">Demo 11</span></span>
    <span class="demo-card-emoji">💰</span>
    <span class="demo-card-title">Finance</span>
    <span class="demo-card-desc">Variance analysis in Excel, board-ready narratives, and forecast commentary.</span>
    <span class="demo-card-cta">Open demo →</span>
  </a>
  <a class="demo-card" href="/MS-4021-Copilot-Immersion-Experience/Instructions/Demos/12-Researcher-Analyst-Demo.html">
    <span class="demo-card-meta"><span class="demo-card-badge">Demo 12</span></span>
    <span class="demo-card-emoji">🔬</span>
    <span class="demo-card-title">Researcher &amp; Analyst</span>
    <span class="demo-card-desc">Put the Researcher and Analyst reasoning agents to work on a real question.</span>
    <span class="demo-card-cta">Open demo →</span>
  </a>
  <a class="demo-card" href="/MS-4021-Copilot-Immersion-Experience/Instructions/Demos/13-Copilot-studio-Demo.html">
    <span class="demo-card-meta"><span class="demo-card-badge">Demo 13</span></span>
    <span class="demo-card-emoji">🤖</span>
...
<div class="card-grid card-grid--compact">
  <a class="pill-link" href="/MS-4021-Copilot-Immersion-Experience/Instructions/Exec/1-business-chat-and-pages.html">
    <span class="pill-link-icon">💬</span>
    <span class="pill-link-title">Copilot Chat &amp; Pages</span>
  </a>
  <a class="pill-link" href="/MS-4021-Copilot-Immersion-Experience/Instructions/Exec/1a-microsoft-365-copilot-chat-web.html">
    <span class="pill-link-icon">🌐</span>
    <span class="pill-link-title">Copilot Chat (Web only)</span>
  </a>
  <a class="pill-link" href="/MS-4021-Copilot-Immersion-Experience/Instructions/Exec/1b-copilot-studio-agent-builder.html">
    <span class="pill-link-icon">🤖</span>
    <span class="pill-link-title">Agent Builder</span>
  </a>
  <a class="pill-link" href="/MS-4021-Copilot-Immersion-Experience/Instructions/Exec/2-copilot-in-word.html">
    <span class="pill-link-icon">📄</span>
    <span class="pill-link-title">Copilot in Word</span>
  </a>
  <a class="pill-link" href="/MS-4021-Copilot-Immersion-Experience/Instructions/Exec/3-microsoft-copilot-work.html">
    <span class="pill-link-icon">🏢</span>
    <span class="pill-link-title">Copilot Chat (Work tab)</span>
  </a>
  <a class="pill-link" href="/MS-4021-Copilot-Immersion-Experience/Instructions/Exec/4-copilot-in-outlook.html">
    <span class="pill-link-icon">📧</span>
    <span class="pill-link-title">Copilot in Outlook</span>
  </a>
  <a class="pill-link" href="/MS-4021-Copilot-Immersion-Experience/Instructions/Exec/5-copilot-in-teams.html">
    <span class="pill-link-icon">👥</span>
    <span class="pill-link-title">Copilot in Teams</span>
  </a>
  <a class="pill-link" href="/MS-4021-Copilot-Immersion-Experience/Instructions/Exec/7-copilot-in-excel.html">
    <span class="pill-link-icon">📈</span>
    <span class="pill-link-title">Copilot in Excel</span>
  </a>
  <a class="pill-link" href="/MS-4021-Copilot-Immersion-Experience/Instructions/Exec/6-microsoft-copilot-web.html">
